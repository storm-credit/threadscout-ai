...
5. legacy/phase documents under `docs/`
...
3. `P0_P1_DECISION_TABLE.md`
4. `TRACEABILITY_MATRIX.md`
5. `ACCEPTANCE_TESTS.md`
6. `FINAL_BLIND_SPOT_SWEEP.md`
7. `B0_TRACEABILITY_MATRIX.md`
8. `../PRE_IMPLEMENTATION_TRAPS.md`
9. the domain specs for the chosen implementation slice
...
Master Design v1 is **approved as design authority**. The design PR may be merged as a documentation baseline without claiming implementation.
...
The current GitHub Actions workflow remains a prototype-regression check; it is not proof that Master Design v1 is implemented.
